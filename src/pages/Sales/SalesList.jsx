...
import {  Plus, Eye, Edit, Trash2, Search, Calendar , Receipt , X } from 'lucide-react';
...
export const SalesList = () => {
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="Sales / Invoices" description="Manage your sales invoices." icon={Receipt}>
